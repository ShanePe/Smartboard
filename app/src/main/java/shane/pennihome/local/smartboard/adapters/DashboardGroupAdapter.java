...
public class DashboardGroupAdapter extends BaseExpandableListAdapter {
    ...
    public int getChildrenCount(int groupPosition) {
        return mSmartboardActivity.getDashboard().getGroupAt(groupPosition).getBlocks().size() == 0 ? 0 : 1;
    }
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return mSmartboardActivity.getDashboard().getGroupAt(groupPosition).getBlocks();
    }
    ...
    public long getChildId(int groupPosition, int childPosition) {
        return mSmartboardActivity.getDashboard().getGroupAt(groupPosition).getBlockAt(childPosition).getIdAsLong();
    }
