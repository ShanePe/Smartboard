...
public class EditGroupNewAdapter extends RecyclerView.Adapter<EditGroupNewAdapter.ViewHolder>
    implements DraggableItemAdapter<EditGroupNewAdapter.ViewHolder>{

    private final SmartboardActivity mSmartboardActivity;

    public EditGroupNewAdapter(SmartboardActivity mSmartboardActivity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dashboard_group_listitem_new, parent, false);
        return new EditGroupNewAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.setGroupHandler(new GroupViewHandler(mSmartboardActivity, parent, holder.mView, group, holder.mRVBlocks));
        ...
        holder.mBtnExpand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RotateImage(holder.mBtnExpand, holder.mExpanded);
            }
        });
    }
    ...
    public boolean onCheckCanStartDrag(ViewHolder holder, int position, int x, int y) {
       // View view = ((RecyclerView)holder.mView).findChildViewUnder(x,y);
        ...
        boolean canDrag = drawRect.contains(x, y);
        return canDrag;
    }
    ...
    private void RotateImage(final ImageButton image, final boolean expanded) {
    ...
    public class ViewHolder extends AbstractDraggableItemViewHolder
    {
        ...
        ImageButton mBtnProps;
        ImageButton mBtnAdd;
        ImageButton mBtnDelete;
        RecyclerView mRVBlocks;
        boolean mExpanded;
        View mView;

        private GroupViewHandler mGroupHandler;
        ...
        public GroupViewHandler getGroupHandler() {
            return mGroupHandler;
        }

        public void setGroupHandler(GroupViewHandler groupHandler) {
