...
public class NetCipher {
    ...
    private final static Proxy ORBOT_HTTP_PROXY = new Proxy(Proxy.Type.HTTP,
     ...
     * @see HttpsURLConnection#setDefaultSSLSocketFactory(SSLSocketFactory)
     */
    private static TlsOnlySocketFactory getTlsOnlySocketFactory(boolean compatible) {
     ...
     */
    private static HttpURLConnection getHttpURLConnection(URL url, boolean compatible)
            throws IOException {
     ...
     *                                  or if an HTTP URL is given that does not support HTTPS
     */
    private static HttpsURLConnection getHttpsURLConnection(URL url, boolean compatible)
            throws IOException {
