...
public class OrbotHelper implements ProxyHelper {
    ...
    final static String ORBOT_PACKAGE_NAME = "org.torproject.android";
     ...
     */
    private final static String STATUS_STARTS_DISABLED = "STARTS_DISABLED";
    ...
    private final static String ORBOT_FDROID_URI = "https://f-droid.org/repository/browse/?fdid="
            + ORBOT_PACKAGE_NAME;
    /**
     * A request to Orbot to transparently start Tor services
     */
    private final static String ACTION_START = "org.torproject.android.intent.action.START";
    /**
     ...
     */
    private final static String ACTION_STATUS = "org.torproject.android.intent.action.STATUS";
    /**
     * A {@link String} {@code packageName} for Orbot to direct its status reply
     * to, used in {@link #ACTION_START} {@link Intent}s sent to Orbot
     */
    private final static String EXTRA_PACKAGE_NAME = "org.torproject.android.intent.extra.PACKAGE_NAME";
    /**
     * All tor-related services and daemons are stopped
     */
    private final static String STATUS_OFF = "OFF";
    private final static String STATUS_STARTING = "STARTING";
    private final static String STATUS_STOPPING = "STOPPING";
    ...
    private final static int START_TOR_RESULT = 0x9234;
...
//    }
    ...
    private final BroadcastReceiver orbotInstallReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context ctxt, Intent intent) {
            if (TextUtils.equals(intent.getAction(),
                ...
                @SuppressWarnings("ConstantConditions") String pkgName = intent.getData().getEncodedSchemeSpecificPart();
    ...
    private static boolean isOrbotInstalled(Context context) {
     ...
     */
    private static boolean requestStartTor(Context context) {
     ...
     */
    private static Intent getOrbotStartIntent(Context context) {
        Intent intent = new Intent(ACTION_START);
        intent.setPackage(ORBOT_PACKAGE_NAME);
    ...
    private static Intent getShowOrbotStartIntent() {
