...
public class PsiphonHelper implements ProxyHelper {
    ...
    private final static String PACKAGE_NAME = "com.psiphon3";
    public final static String ORBOT_PLAY_URI = "https://play.google.com/store/apps/details?id="
            + PACKAGE_NAME;
    private final static String COMPONENT_NAME = "com.psiphon3.StatusActivity";
    private final static String MARKET_URI = "market://details?id=" + PACKAGE_NAME;
    private final static String FDROID_URI = "https://f-droid.org/repository/browse/?fdid="
            + PACKAGE_NAME;
    ...
    private static boolean isPortOpen(final String ip, final int port, final int timeout) {
        try {
