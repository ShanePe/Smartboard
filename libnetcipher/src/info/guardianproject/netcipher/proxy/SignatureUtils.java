...
class SignatureUtils {
    ...
    private static String getSignatureHash(Context ctxt, String packageName)
            throws
            NameNotFoundException,
            NoSuchAlgorithmException {
        MessageDigest md = MessageDigest.getInstance("SHA-256");
        @SuppressLint("PackageManagerGetSignatures") Signature sig =
    ...
    public static Intent validateBroadcastIntent(Context ctxt,
                                                 ...
                                                 String sigHash,
                                                 boolean failIfHack) {
        ArrayList<String> sigHashes = new ArrayList<>();
     ...
     * name of the target activity added to the Intent
     */
    private static Intent validateActivityIntent(Context ctxt,
                                                 Intent toValidate,
                                                 List<String> sigHashes,
                                                 boolean failIfHack) {
        PackageManager pm = ctxt.getPackageManager();
     ...
     * name of the target service added to the Intent
     */
    private static Intent validateServiceIntent(Context ctxt,
                                                Intent toValidate,
                                                List<String> sigHashes,
                                                boolean failIfHack) {
        PackageManager pm = ctxt.getPackageManager();
